...
-- SOURCE CODE JAVA (.java) sau khi được COMPILE sẽ trở thành BYTECODE (.class), sau đó BYCODE sẽ được thực thi (EXECUTION) bởi JVM để trở thành ngôn ngữ máy cho từng loại
HỆ ĐIỀU HÀNH.
